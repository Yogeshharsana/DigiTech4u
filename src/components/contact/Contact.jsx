    ...
    <section className="contact section" id="contact">
      ...
      <div className="contact_container container grid">
        <div className="contact_content">
          <h3 className="contact_title">Connect with us</h3>
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card_data">info@digitech4u.com</span>

              <a href="mailto:info@digitech4u.com" className="contact_button">
                Write me
        ...
        <div className="contact_content">
          {isMessageSent ? (
            ...
            <>
              <h3 className="contact_title">Write us your enquiry</h3>
